                    <div class="modal-body" style="text-align:justify;">
                      <p>
                        ...
                        <b>Sevgili Gönüllü,</b>
                        <br><br>
                        Katılacak olduğunuz çalışma bir araştırma niteliğindedir. Bu araştırmaya Ankara Üniversitesi Tıp Fakültesi Çocuk Metabolizma Bilim Dalı’nda takip eden gönüllü hastalar dahil edilecektir. Araştırmamızdan kısaca bahsetmek istemekteyiz.
                        <br><br>
                        ...
                        <br><br>
                        Eğer çalışma ile ilgili daha detaylı bilgi almak isterseniz veya çalışma süresince aklınıza takılan bir soru olursa, çalışmanın sorumlu yürütücüsü ve yardımcı araştırıcısı olan Doç. Dr. Tuba EMİNOĞLU ve Dr. Merve KOÇ YEKEDÜZ’e danışabilirsiniz.
                        <br><br>
                        ...
                        GÖNÜLLÜ OLURU
                        <br>
                        Hastanın Anne/Babasının Adı Soyadı: <b>{{ \App\Models\User::where('id', $user_id)->value('name') }}</b>
                        <br>
                        Tarih: <b>{{ date('d-m-Y') }}</b>
                        <br>
                        Telefon: <b>{{ \App\Models\User::where('id', $user_id)->value('phone') }}</b>
                        <br>
                        <b>*</b><i>Onam formu, hastanın anne/babası tarafından onaylanacaktır.</i>
                        <br><br>
                        Bu sayfayı imzalamakla gönüllü olarak çalışmaya katılmayı kabul etmiş olacağım konusunda bilgilendirildim. Yukarıdaki bilgileri okudum. Aynı zamanda bana sözlü açıklama da yapıldı. Bu koşullar altında, kendi rızam ile bu çalışmaya katılmayı kabul ediyorum.
                      </p>
                    </div>
