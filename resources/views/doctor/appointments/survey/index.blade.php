...
li[data-type=control_fileupload] .qq-upload-button,.until-text,.form-submit-reset{color:#2c3345}
.stageEmpty.isSmall{color:#CAD0CF}
.rating-item label{color:#8894ab}
.currentDate,.pickerItem select,.appointmentCalendar .calendarDay,.calendar.popup th,.calendar.popup table tbody td,.calendar-new-header>*,.form-collapse-table{color:#2C3345}
.appointmentCalendar .dayOfWeek{color:#2e69ff}
.appointmentSlotsContainer > *{color:#2e69ff}
li[data-type=control_fileupload] .jfUpload-heading,::placeholder,.form-dropdown.is-active,.form-dropdown:first-child,.form-spinner-input{color:#57647e}
.appointmentCalendar .calendarWeek .calendarDay.isUnavailable,.calendar tr.days td.otherDay,.calendar tr.days td:hover:not(.unselectable){color:#CAD0CF}
span.form-sub-label,label.form-sub-label,div.form-header-group .form-subHeader,.rating-item-title.for-to > label:first-child,.rating-item-title.for-from > label:first-child,.rating-item-title .editor-container *{color:#57647E}
.form-pagebreak-back{color:#2c3345}
.rating-item input:checked+label,.rating-item input:focus+label{color:#FFF}
.clear-pad-btn{color:#57647e}
.form-textbox::placeholder,.form-dropdown:not(.time-dropdown):not(:required),.form-dropdown:not(:required),.form-dropdown:required:invalid{color:#8894ab}
...
.rating-item input:hover+label{border-color:#2e69ff}
.appointmentSlot,.form-checkbox:checked+label:before,.form-checkbox:checked+span:before,.form-checkbox:checked+span label:before,.form-radio:checked+label:before,.form-radio:checked+span:before,.form-dropdown:focus,.form-textarea:focus,.form-textbox:focus,.signature-wrapper:focus,.form-line[data-payment="true"] .form-product-item .p_checkbox .checked,.form-dropdown:hover,.form-textarea:hover,.form-textbox:hover,.signature-wrapper:hover{border-color:#2e69ff}
.calendar tr.days td:hover:not(.unselectable):after{border-color:#e5eaf4}
.form-header-group,.form-buttons-wrapper,.form-pagebreak,.form-submit-clear-wrapper,.form-pagebreak-next,.form-pagebreak-back,.form-checkbox:hover+label:before,.form-checkbox:hover+span:before,.form-radio:hover+label:before,.form-radio:hover+span:before{border-color:#ECEDF3}
.form-line-active{background-color:#F1F5FF}
.form-line-error{background-color:#FFD6D6}
.form-matrix-column-headers,.form-matrix-row-headers,.form-spinner-button-container>*,.form-collapse-table,.form-collapse-table:hover,.appointmentDayPickerButton{background-color:#e5eaf4}
.calendar.popup,.calendar.popup table,.calendar.popup table tbody td:after{background-color:#FFF}
.appointmentCalendar .calendarDay.isActive .calendarDayEach,.appointmentFieldRow.forSelectedDate,.calendar.popup tr.days td.selected:after,.calendar.popup:after,.submit-button,.form-checkbox:checked+label:before,.form-checkbox:checked+span:before,.form-checkbox:checked+span label:before,.form-radio+label:after,.form-radio+span:after,.rating-item input:checked+label,.appointmentCalendar .calendarDay:after,.form-line[data-payment="true"] .form-product-item .p_checkbox .checked,.rating-item input:focus+label{background-color:#2e69ff}
.appointmentSlot.active{background-color:#2e69ff!important}
.clear-pad-btn,.appointmentCalendar .dayOfWeek,.calendar.popup th{background-color:#eef3ff!important}
.appointmentField .timezonePicker:hover+.timezonePickerName,.form-spinner-button-container>:hover{background-color:#eef3ff}
.form-matrix-values,.form-matrix-values,.signature-wrapper,.signature-pad-passive,.rating-item label,.form-checkbox+label:before,.form-checkbox+span:before,.form-radio+label:before,.form-radio+span:before{background-color:#FFF}
li[data-type=control_fileupload] .qq-upload-button{background-color:#fbfcff}
.JotFormBuilder .appContainer #app li.form-line[data-type=control_matrix].isSelected
.questionLine-editButton.forRemove:after,.JotFormBuilder .appContainer #app li.form-line[data-type=control_matrix].isSelected .questionLine-editButton.forRemove:before{background-color:#8894ab}
.appointmentCalendarContainer,.appointmentSlot,.rating-item-title.for-to > label:first-child,.rating-item-title.for-from > label:first-child,.rating-item-title .editor-container *,.calendar-opened{background-color:transparent}
.appointmentCalendar .calendarDay.isSelected:after{color:#FFF}
.form-dropdown:hover,.form-textarea:hover,.form-textbox:hover,.signature-wrapper:hover,.calendar.popup:before,.jSignature:hover,li[data-type=control_fileupload] .qq-upload-button-hover,.form-line[data-payment="true"] .form-product-item .p_checkbox .checked,.form-line[data-payment="true"] .form-product-item .p_checkbox:hover .select_border,.form-checkbox:hover+label:before,.form-checkbox:hover+span:before,.form-radio:hover+label:before,.form-radio:hover+span:before,.calendar.popup:before{border-color:rgba(169,191,249,0.5);box-shadow:0 0 0 2px rgba(201,216,254,0.25)}
.form-dropdown:focus,.form-textarea:focus,.form-textbox:focus,.signature-wrapper:focus,li[data-type=control_fileupload] .qq-upload-button-focus,.form-checkbox:focus+label:before,.form-checkbox:focus+span:before,.form-radio:focus+label:before,.form-radio:focus+span:before,.calendar.popup:before{border-color:rgba(46,105,255,1);box-shadow:0 0 0 3px rgba(201,216,254,0.25)}
.calendar.popup table tbody td{box-shadow:none}
.submit-button{background-color:#18BD5B;border-color:#18BD5B}
.submit-button:hover{background-color:#16AA52;border-color:#16AA52}
.form-pagebreak-next{background-color:#2e69ff}
.form-pagebreak-back{background-color:#e5e7f2}
...
.form-sacl-button,.form-submit-print{background-color:transparent;color:#2c3345;border-color:rgba(195,202,216,0.75)}
.form-sacl-button:hover,.form-submit-print:hover,.appointmentSlot:not(.disabled):not(.active):hover,.appointmentDayPickerButton:hover,.rating-item input:hover+label{background-color:#96B4FF}
.form-line[data-payment=true] .form-textbox,.form-line[data-payment=true] .select-area,.form-line[data-payment=true] #coupon-input,.form-line[data-payment=true] #coupon-container input,.form-line[data-payment=true] input#productSearch-input,.form-line[data-payment=true] .form-product-category-item:after,.form-line[data-payment=true] .filter-container .dropdown-container .select-content,.form-line[data-payment=true] .form-textbox.form-product-custom_quantity,.form-line[data-payment="true"] .form-product-item .p_checkbox .select_border,.form-line[data-payment="true"] .form-product-item .form-product-container .form-sub-label-container span.select_cont,.form-line[data-payment=true] select.form-dropdown{border-color:rgba(195,202,216,0.75);border-color:#C3CAD8}
.form-line[data-payment="true"] hr,.form-line[data-payment=true] .p_item_separator,.form-line[data-payment="true"] .payment_footer.new_ui,.form-line.card-3col .form-product-item.new_ui,.form-line.card-2col .form-product-item.new_ui{border-color:rgba(195,202,216,0.75);border-color:rgba(195,202,216,.5)}
.form-line[data-payment=true] .form-product-category-item{border-color:rgba(195,202,216,0.75);border-color:#d9dde4}
.form-line[data-payment=true] #coupon-input,.form-line[data-payment=true] .form-textbox.form-product-custom_quantity,.form-line[data-payment=true] input#productSearch-input,.form-line[data-payment=true] .select-area,.form-line[data-payment=true] .custom_quantity,.form-line[data-payment=true] .filter-container .select-content,.form-line[data-payment=true] .p_checkbox .select_border{background-color:#FFF}
.form-product-category-item:after{background-color:#fff;border-color:#fff}
.form-line[data-payment=true].form-line.card-3col .form-product-item,.form-line[data-payment=true].form-line.card-2col .form-product-item{background-color:undefined}
.form-line[data-payment=true] .payment-form-table input.form-textbox,.form-line[data-payment=true] .payment-form-table input.form-dropdown,.form-line[data-payment=true] .payment-form-table .form-sub-label-container > div,.form-line[data-payment=true] .payment-form-table span.form-sub-label-container iframe,.form-line[data-type=control_square] .payment-form-table span.form-sub-label-container iframe{border-color:rgba(195,202,216,0.75)}
...
.form-all .qq-upload-button,.form-all .form-submit-button,.form-all .form-submit-reset,.form-all .form-submit-print{font-family:Inter,sans-serif}
...
.form-all{position:relative}
.form-all:before{content:"";background-image:url(/logo.png);display:inline-block;height:70px;position:absolute;background-size:280px 70px;background-repeat:no-repeat;width:100%}
.form-all{margin-top:90px!important}
.form-all:before{top:-80px;background-position:top center}
  ...
  <div role="main" class="form-all">
    ...
    <ul class="form-section page-section" style="display:none;">
      ...
      <li id="cid_18" class="form-input-wide" data-type="control_pagebreak">
        <div class="form-pagebreak" data-component="pagebreak">
          <div class="form-pagebreak-back-container">
            <button id="form-pagebreak-back_18" type="button" class="form-pagebreak-back  jf-form-buttons" data-component="pagebreak-back">
              Geri
            </button>
          </div>
          <div class="form-pagebreak-next-container">
            <button id="form-pagebreak-next_18" type="button" class="form-pagebreak-next  jf-form-buttons" data-component="pagebreak-next">
              İleri
            </button>
          </div>
          <div style="clear:both" class="pageInfo form-sub-label" id="pageInfo_18">
          </div>
        </div>
      </li>
    </ul>
      ...
      <li class="form-line" data-type="control_matrix" id="id_36">
        ...
        <div id="cid_36" class="form-input-wide" data-layout="full">
          <table summary="" role="presentation" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix" style="text-align:left;">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_1">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_2">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_3">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_4">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_5">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_6">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_7">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_8">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_36 label_36_row_9">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
        ...
        <div id="cid_41" class="form-input-wide" data-layout="full">
          <table summary="" role="presentation" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix" style="text-align:left;">
            <tr class="form-matrix-tr form-matrix-header-tr">
              ...
              <th scope="col" class="form-matrix-headers form-matrix-column-headers form-matrix-column_1">
                <label id="label_41_col_1"> 2 </label>
              </th>
              <th scope="col" class="form-matrix-headers form-matrix-column-headers form-matrix-column_2">
                <label id="label_41_col_2"> 3 </label>
              </th>
              <th scope="col" class="form-matrix-headers form-matrix-column-headers form-matrix-column_3">
                <label id="label_41_col_3"> 4 </label>
              </th>
              <th scope="col" class="form-matrix-headers form-matrix-column-headers form-matrix-column_4">
                <label id="label_41_col_4"> 5 </label>
              </th>
            </tr>
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_0">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_1">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_2">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_3">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_4">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_5">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_6">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_7">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_8">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
            ...
            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_41 label_41_row_9">
              <th scope="row" class="form-matrix-headers form-matrix-row-headers">
