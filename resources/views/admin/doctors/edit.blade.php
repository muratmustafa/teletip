              ...
              <form action="{{ route('admin.doctors.update',$doctor->id) }}" method="post">
                ...
                <div class="card-body">@if ($errors->any())
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="inputName" name="name" placeholder="Ad Soyad" value="{{ $doctor->name }}" required>
                  </div>
                  <div class="form-group">
                    <label for="inputBranch">Birim</label>
                    <input type="text" class="form-control" id="inputBranch" name="branch" placeholder="Birimi" value="{{ $doctor->branch }}">
                  </div>
                  <div class="form-group">
                    <label for="inputEmail">E-posta</label>
                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="inputEmail" name="email" placeholder="E-posta adresi" value="{{ $doctor->email }}" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{ route('admin.doctors.index') }}"><div class="btn btn-default">Vazgeç</div></a>
                </div>
              </form>
            </div>
          </div>
